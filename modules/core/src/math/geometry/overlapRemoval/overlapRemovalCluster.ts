...
import Microsoft.Msagl.Core.ProjectionSolver;
// 
//  How Clusters Work
// 
//  As in the doc, we extend the existing constraint-generation mechanism by processing a
...
module Microsoft.Msagl.Core.Geometry {
    ...
    export class OverlapRemovalCluster extends OverlapRemovalNode {
        ...
        //  Our internal Node list - some of which may be Clusters.
        nodeList: List<OverlapRemovalNode> = new List<OverlapRemovalNode>();
        
        //  Our internal child Cluster list - duplicated from nodeList for iterative recursion perf.
        clusterList: List<OverlapRemovalCluster> = new List<OverlapRemovalCluster>();
        ...
        ///  </summary>
        //  AKA: "Bump Mode"
        public get TranslateChildren(): boolean {
        }
        public set TranslateChildren(value: boolean)  {
        }
        ...
        ///  The internal Node containing the Variable to which left-border constraints are made.
        ///  </summary>
        public get LeftBorderNode(): OverlapRemovalNode {
        }
        public set LeftBorderNode(value: OverlapRemovalNode)  {
        }
        
        ///  <summary>
        ///  The internal Node containing the Variable to which right-border constraints are made.
        ///  </summary>
        public get RightBorderNode(): OverlapRemovalNode {
        }
        public set RightBorderNode(value: OverlapRemovalNode)  {
        }
        
        //  Indicates if the cluster's GenerateWorker placed anything into the solver.
        get IsInSolver(): boolean {
        }
        set IsInSolver(value: boolean)  {
        }
        ...
        ///  along the primary axis; on Left if horizontal, else on Top.
        ///  </summary>
        public get OpenBorderInfo(): BorderInfo {
        }
        public set OpenBorderInfo(value: BorderInfo)  {
        }
        ...
        ///  along the primary axis; on Right if horizontal, else on Bottom.
        ///  </summary>
        public get CloseBorderInfo(): BorderInfo {
        }
        public set CloseBorderInfo(value: BorderInfo)  {
        }
        ...
        ///  along the secondary (Perpendicular) axis; on Top if horizontal, else on Left.
        ///  </summary>
        public get OpenBorderInfoP(): BorderInfo {
        }
        public set OpenBorderInfoP(value: BorderInfo)  {
        }
        ...
        ///  along the secondary (Perpendicular) axis; on Bottom if horizontal, else on Right.
        ///  </summary>
        public get CloseBorderInfoP(): BorderInfo {
        }
        public set CloseBorderInfoP(value: BorderInfo)  {
        }
        ...
        ///  Minimum size along the perpendicular axis.
        ///  </summary>
        public get MinimumSizeP(): number {
        }
        public set MinimumSizeP(value: number)  {
        }
        ...
        ///  Padding of nodes within the cluster in the perpendicular direction.
        ///  </summary>
        public get NodePaddingP(): number {
        }
        public set NodePaddingP(value: number)  {
        }
        
        ///  <summary>
        ///  Padding outside the cluster in the parallel direction.
        ///  </summary>
        public get ClusterPadding(): number {
        }
        public set ClusterPadding(value: number)  {
        }
        
        ///  <summary>
        ///  Padding outside the cluster in the perpendicular direction.
        ///  </summary>
        public get ClusterPaddingP(): number {
        }
        public set ClusterPaddingP(value: number)  {
        }
        ...
        //  VERBOSE
        //  The number of node IDs used by a Cluster - for the cluster itself and its fake nodes.
        private /* internal */ static get NumInternalNodes(): number {
            return 3;
        }
        
        //  The width (height) of the node along the primary axis, which should be fairly thin
        //  (along the secondary (perpendicular) axis, it is the full size of the cluster).
        private /* internal */ static get DefaultBorderWidth(): number {
        ...
        ///  in the root, which may be numerous.
        ///  </summary>
        public get IsRootCluster(): boolean {
            return (this.ParentCluster == null);
        }
        
        get ParentCluster(): OverlapRemovalCluster {
        }
        set ParentCluster(value: OverlapRemovalCluster)  {
        }
        
        //  Zero cluster margins. This ctor is currently used only by the generator's DefaultClusterHierarchy,
        //  which by default is created with non-fixed borders and no margins.
        private /* internal */ constructor (id: number, parentCluster: OverlapRemovalCluster, userData: Object, padding: number, paddingP: number) : 
                this(id, parentCluster, userData, 0, 0, padding, paddingP, 0, 0, new BorderInfo(0), new BorderInfo(0), new BorderInfo(0), new BorderInfo(0)) {
            
        }
        
        private /* internal */ constructor (id: number, parentCluster: OverlapRemovalCluster, userData: Object, minSize: number, minSizeP: number, nodePadding: number, nodePaddingP: number, clusterPadding: number, clusterPaddingP: number, openBorderInfo: BorderInfo, closeBorderInfo: BorderInfo, openBorderInfoP: BorderInfo, closeBorderInfoP: BorderInfo) : 
                base(id, userData) {
            this.MinimumSize = minSize;
            this.MinimumSizeP = minSizeP;
            this.NodePadding = nodePadding;
        ...
        CreateBorderNodes() {
            if (!this.IsRootCluster) {
                let strNodeIdR: string = null;
                let strNodeIdL: string = null;
                #if ((VERIFY || VERBOSE))
                strNodeIdL = ("L" + this.UserDataString);
                strNodeIdR = ("R" + this.UserDataString);
                #endif
        ...
        //  Enumerates only cluster children of this cluster.
        private /* internal */ get Clusters(): IEnumerable<OverlapRemovalCluster> {
        ...
        public /* override */ ToString(): string {
            //  Currently this is just the same as the base Node; all zero if we haven't
            //  yet called Solve(), else the values at the last time we called Solve().
            return string.Format(System.Globalization.CultureInfo.InvariantCulture, "Cluster '{0}': id {1} p {2:F5} s {3:F5} pP {4:F5} sP {5:F5}", this.UserDataString, this.Id, this.Position, this.Size, this.PositionP, this.SizeP);
        }
        
        //  newNode may be a cluster in which case we add it to the cluster list.  We never call this to
        //  add the fake border nodes to nodeList; the caller never sees them.
        private /* internal */ AddNode(newNode: OverlapRemovalNode) {
            this.nodeList.Add(newNode);
            let newCluster = (<OverlapRemovalCluster>(newNode));
            if ((newCluster != null)) {
                this.clusterList.Add(newCluster);
            }
        ...
        //  Adds an open/close event pair for the node. paddingP is either cluster or node padding.
        AddEvents(node: OverlapRemovalNode, events: List<Event>) {
            //  Add/subtract only half the padding so they meet in the middle of the padding.
            events.Add(new Event(true, node, (node.OpenP 
                                - (this.NodePaddingP / 2))));
            events.Add(new Event(false, node, (node.CloseP 
                                + (this.NodePaddingP / 2))));
        }
        
        //  This is internal rather than  so Test_OverlapRemoval can see it.
        private /* internal */ static CalcBorderWidth(margin: number): number {
            //  Margin applies only to the inside edge.
            if ((margin > 0)) {
                return margin;
            }
        ...
        class ClusterItem {
            ...
            private /* internal */ Cluster: OverlapRemovalCluster;
            
            private /* internal */ ChildrenHaveBeenPushed: boolean;
            
            private /* internal */ constructor (cluster: OverlapRemovalCluster) {
                this.Cluster = cluster;
            }
        }
        
        export class ClusterDelegate extends System.Delegate {
        }
        
        static ProcessClusterHierarchy(root: OverlapRemovalCluster, worker: ClusterDelegate) {
            let stack = new Stack<ClusterItem>();
            stack.Push(new ClusterItem(root));
            while ((stack.Count > 0)) {
                //  Keep the cluster on the stack until we're done with its children.
                let item = stack.Peek();
                let prevStackCount: number = stack.Count;
                if (!item.ChildrenHaveBeenPushed) {
                    item.ChildrenHaveBeenPushed = true;
                    for (let childCluster in item.Cluster.Clusters) {
                        stack.Push(new ClusterItem(childCluster));
                    }
        ...
        private /* internal */ Generate(solver: Solver, parameters: OverlapRemovalParameters, isHorizontal: boolean) {
            OverlapRemovalCluster.ProcessClusterHierarchy(this, () => {  }, cluster.IsInSolver=cluster.GenerateWorker(solver,parameters,isHorizontalUnknown);
            OverlapRemovalCluster.ProcessClusterHierarchy(this, () => {  }, cluster.SqueezeNonFixedBorderPositions());
        }
        ...
        SqueezeNonFixedBorderPositions() {
            ...
            let leftBorderDesiredPos: number = this.LeftBorderNode.Position;
            let rightBorderDesiredPos: number = this.RightBorderNode.Position;
            if (!this.OpenBorderInfo.IsFixedPosition) {
                this.LeftBorderNode.Variable.DesiredPos = rightBorderDesiredPos;
            }
        ...
        GenerateWorker(solver: Solver, parameters: OverlapRemovalParameters, isHorizontal: boolean): boolean {
            ...
            //  The list of open/close events, which will be sorted on the perpendicular coordinate of the event
            //  (e.g. for horizontal constraint generation, order on vertical position).
            let events = this.CreateEvents(solver, /* ref */boundaryRect);
            //  If we added no events, we're either Fixed (so continue) or empty (so return).
            if (((events.Count == 0) 
            ...
            //  Top/Bottom are considered the secondary (Perpendicular) axis here.
            let leftBorderWidth: number = DefaultBorderWidth;
            let rightBorderWidth: number = DefaultBorderWidth;
            if (!this.IsRootCluster) {
                this.CalculateBorderWidths(solver, events, boundaryRect, /* out */leftBorderWidth, /* out */rightBorderWidth);
                #if (VERBOSE)
                System.Diagnostics.Debug.WriteLine(" {0} After CalculateBorderWidths: p {1:F5} s {2:F5} pP {3:F5} sP {4:F5}", this.Name, this.Size, this.Position, this.Size, this.SizeP);
                #endif
            }
        ...
        CreateEvents(solver: Solver, /* ref */boundaryRect: Rectangle): List<Event> {
            let events = new List<Event>();
            let cNodes: number = this.nodeList.Count;
            //  cache for perf
            let leftBorderWidth: number = CalcBorderWidth(this.OpenBorderInfo.InnerMargin);
            let rightBorderWidth: number = CalcBorderWidth(this.CloseBorderInfo.InnerMargin);
            let openBorderWidth: number = CalcBorderWidth(this.OpenBorderInfoP.InnerMargin);
            let closeBorderWidth: number = CalcBorderWidth(this.CloseBorderInfoP.InnerMargin);
            for (let nodeIndex: number = 0; (nodeIndex < cNodes); nodeIndex++) {
                let node: OverlapRemovalNode = this.nodeList[nodeIndex];
                let cluster = (<OverlapRemovalCluster>(node));
                if ((cluster != null)) {
                    //  Child Clusters have already "recursively" been processed before the current cluster,
                    //  so we just need to check to see if it had any events.  If so, then it has created its
                    //  two fake nodes (and their variables) along the primary axis, but these are only put
                ...
                //  Update our boundaries if this node goes past any of them.
                if (!this.IsRootCluster) {
                    let pad: number = ((node.Size / 2) 
                                + this.ClusterPadding);
                    let padP: number = ((node.SizeP / 2) 
                                + this.ClusterPaddingP);
                    let newLeft: number = (node.Position 
                                - (pad - leftBorderWidth));
                    let newRight: number = (node.Position 
                                + (pad + rightBorderWidth));
                    let newBottom: number = (node.PositionP 
                                - (padP - openBorderWidth));
                    let newTop: number = (node.PositionP 
                                + (padP + closeBorderWidth));
                    boundaryRect.Left = Math.Min(boundaryRect.Left, newLeft);
                    boundaryRect.Right = Math.Max(boundaryRect.Right, newRight);
                    boundaryRect.Bottom = Math.Min(boundaryRect.Bottom, newBottom);
                    boundaryRect.Top = Math.Max(boundaryRect.Top, newTop);
                    #if (VERBOSE)
                    System.Diagnostics.Debug.WriteLine(" {0} BoundaryRect after AddEvents: L/R T/B {1:F5}/{2:F5} {3:F5}/{4:F5}", this.Name, boundaryRect.Left, boundaryRect.Right, boundaryRect.Top, boundaryRect.Bottom);
                    #endif
                }
            ...
            if (!this.IsRootCluster) {
                ...
                //  Without the full cluster boundaries being available at constraint generation time, Tuvalu was
                //  getting unresolved overlaps when dragging an external node over the corner of a cluster boundary.
                let padMinSize: number = (this.MinimumSize - boundaryRect.Width);
                if ((padMinSize > 0)) {
                    boundaryRect.PadWidth((padMinSize / 2));
                }
                
                let padMinSizeP: number = (this.MinimumSizeP - boundaryRect.Height);
                if ((padMinSizeP > 0)) {
                    boundaryRect.PadHeight((padMinSizeP / 2));
                }
                
                #if (VERBOSE)
                System.Diagnostics.Debug.WriteLine(" {0} BoundaryRect after CreateEvents: L/R T/B {1:F5}/{2:F5} {3:F5}/{4:F5}", this.Name, boundaryRect.Left, boundaryRect.Right, boundaryRect.Top, boundaryRect.Bottom);
                #endif
            }
        ...
        CalculateBorderWidths(solver: Solver, events: List<Event>, boundaryRect: Rectangle, /* out */leftBorderWidth: number, /* out */rightBorderWidth: number) {
            //  Cluster-level padding (the space around the borders) complicates this.  Margin
            //  is added only at the inside edge of the cluster; for example, as space for a
            //  title of the cluster to be printed.  We just use the margin as the boundary node
            //  sizes.  Margin is separate from padding; padding is always added.
            ...
            //  fixed-position; this ensures that the scan line will correctly see their open and close.
            //  Left/Open...
            this.LeftBorderNode.Position = (boundaryRect.Left 
                        + (leftBorderWidth / 2));
            this.LeftBorderNode.Size = leftBorderWidth;
            this.LeftBorderNode.Weight = this.OpenBorderInfo.Weight;
            this.LeftBorderNode.PositionP = this.PositionP;
            ...
            //   since here Open is in the primary axis and in GenerateFromEvents it's in the secondary/P axis.
            //  Right/Close...
            this.RightBorderNode.Position = (boundaryRect.Right 
                        - (rightBorderWidth / 2));
            this.RightBorderNode.Size = rightBorderWidth;
            this.RightBorderNode.Weight = this.CloseBorderInfo.Weight;
            this.RightBorderNode.PositionP = this.PositionP;
        ...
        AdjustFixedBorderPositions(solver: Solver, leftBorderWidth: number, rightBorderWidth: number, isHorizontal: boolean) {
            ...
            if ((this.OpenBorderInfo.IsFixedPosition && this.CloseBorderInfo.IsFixedPosition)) {
                ...
                //  to set the position to the midpoint.  Since both borders are fixed, this provides a
                //  limit to the size of the overall node.
                this.LeftBorderNode.UpdateDesiredPosition((this.OpenBorderInfo.FixedPosition 
                                + (leftBorderWidth / 2)));
                this.RightBorderNode.UpdateDesiredPosition((this.CloseBorderInfo.FixedPosition 
                                - (rightBorderWidth / 2)));
                this.Size = (this.CloseBorderInfo.FixedPosition - this.OpenBorderInfo.FixedPosition);
                this.Position = (this.OpenBorderInfo.FixedPosition 
                            + (this.Size / 2));
            }
            else if ((this.OpenBorderInfo.IsFixedPosition || this.CloseBorderInfo.IsFixedPosition)) {
                //  One border is fixed and the other isn't.  We'll keep the same cluster size,
                ...
                if (this.OpenBorderInfo.IsFixedPosition) {
                    ...
                    this.RightBorderNode.UpdateDesiredPosition((this.CloseBorderInfo.FixedPosition 
                                    - (rightBorderWidth / 2)));
                    this.Position = (this.CloseBorderInfo.FixedPosition 
                                - (this.Size / 2));
                }
            ...
            if ((this.MinimumSize > 0)) {
                let cst: Constraint = solver.AddConstraint(this.LeftBorderNode.Variable, this.RightBorderNode.Variable, (this.MinimumSize 
                                - ((leftBorderWidth / 2) 
                                - (rightBorderWidth / 2))));
                Debug.Assert((cst != null), "Minimum Cluster size: unexpected null cst");
                #if (VERBOSE)
            ...
            if ((this.OpenBorderInfoP.IsFixedPosition || this.CloseBorderInfoP.IsFixedPosition)) {
                ...
                if ((this.OpenBorderInfoP.IsFixedPosition && this.CloseBorderInfoP.IsFixedPosition)) {
                    this.SizeP = (this.CloseBorderInfoP.FixedPosition - this.OpenBorderInfoP.FixedPosition);
                    this.PositionP = (this.OpenBorderInfoP.FixedPosition 
                                + (this.SizeP / 2));
                    if ((this.SizeP < 0)) {
                        //  Open border is to the right of close border; they'll move later, but we have to
                        //  make the size non-negative.  TODOunit: create a specific test for this (fixed LRTB)
                    ...
                    //    between the fixed border and the outermost nodes (it will never *reduce* this distance
                    //    of course).  This means we adjust both border position and our overall node size.
                    let curTopOuterBorder: number = (this.PositionP 
                                - (this.SizeP / 2));
                    let curBottomOuterBorder: number = (this.PositionP 
                                + (this.SizeP / 2));
                    if (this.OpenBorderInfoP.IsFixedPosition) {
                        if (isHorizontal) {
                            //  Don't change SizeP.
                            this.PositionP = (this.PositionP 
                                        + (this.OpenBorderInfoP.FixedPosition - curTopOuterBorder));
                        }
                        else {
                            this.SizeP = (curBottomOuterBorder - this.OpenBorderInfoP.FixedPosition);
                            this.PositionP = (this.OpenBorderInfoP.FixedPosition 
                        ...
                        //  Don't change SizeP.
                        this.PositionP = (this.PositionP 
                                    + (this.CloseBorderInfoP.FixedPosition - curBottomOuterBorder));
                    }
                    else {
                        this.SizeP = (this.CloseBorderInfoP.FixedPosition - curTopOuterBorder);
                        this.PositionP = (curTopOuterBorder 
                                    + (this.SizeP / 2));
                    }
        ...
        //  - Else it is being operated on as the right neighbour, so use its left border as the
        //    variable TO which we create the constraint.
        private /* internal */ static GetLeftConstraintNode(node: OverlapRemovalNode): OverlapRemovalNode {
            let cluster = (<OverlapRemovalCluster>(node));
            return cluster.RightBorderNode;
            // TODO: Warning!!!, inline IF is not supported ?
            (cluster != null);
            node;
        }
        
        private /* internal */ static GetRightConstraintNode(node: OverlapRemovalNode): OverlapRemovalNode {
            let cluster = (<OverlapRemovalCluster>(node));
            return cluster.LeftBorderNode;
            // TODO: Warning!!!, inline IF is not supported ?
            (cluster != null);
            node;
        }
        
        GenerateFromEvents(solver: Solver, parameters: OverlapRemovalParameters, events: List<Event>, isHorizontal: boolean) {
            //  First, sort the events on the perpendicular coordinate of the event
            //  (e.g. for horizontal constraint generation, order on vertical position).
            events.Sort();
            #if (VERBOSE)
            System.Diagnostics.Debug.WriteLine("Events:");
            for (let evt: Event in events) {
                System.Diagnostics.Debug.WriteLine("    {0}", evt);
            }
            ...
            for (let evt: Event in events) {
                let currentNode: OverlapRemovalNode = evt.Node;
                if (evt.IsForOpen) {
                    //  Insert the current node into the scan line.
                    scanLine.Insert(currentNode);
                    #if (VERBOSE)
                    ...
                    //  variable out of the loop so .Count isn't checked on each iteration, since we know it's
                    //  not going to be changed).
                    let numLeftNeighbors: number = currentNode.LeftNeighbors.Count;
                    let numRightNeighbors: number = currentNode.RightNeighbors.Count;
                    //  If there is currently a non-overlap constraint between any two nodes across the
                    //  two neighbour lists we've just created, we can remove them because they will be
                    //  transitively enforced by the constraints we'll create for the current node.
                    //  I.e., we can remove the specification for the constraint
                    ...
                    //  but that forms a new inner loop (iterating all lnbours before adding a new one)
                    //  unless we develop different storage for nbours.
                    for (let ii: number = 0; (ii < numLeftNeighbors); ii++) {
                        let leftNeighborNode: OverlapRemovalNode = currentNode.LeftNeighbors[ii];
                        for (let jj: number = 0; (jj < numRightNeighbors); jj++) {
                            //  TODOunit: test this
                            let nodeToRemove: OverlapRemovalNode = currentNode.RightNeighbors[jj];
                            if (leftNeighborNode.RightNeighbors.Remove(nodeToRemove)) {
                                #if (VERBOSE)
                    ...
                    for (let ii: number = 0; (ii < numRightNeighbors); ii++) {
                        //  TODOunit: test this
                        let rightNeighborNode: OverlapRemovalNode = currentNode.RightNeighbors[ii];
                        for (let jj: number = 0; (jj < numLeftNeighbors); jj++) {
                            let nodeToRemove: OverlapRemovalNode = currentNode.LeftNeighbors[jj];
                            if (rightNeighborNode.LeftNeighbors.Remove(nodeToRemove)) {
                                #if (VERBOSE)
                ...
                //  should be involved in the constraint (if it's the left neighbour then use its
                //  right border as the constraint variable, and vice-versa).
                let currentLeftNode: OverlapRemovalNode = OverlapRemovalCluster.GetLeftConstraintNode(currentNode);
                let currentRightNode: OverlapRemovalNode = OverlapRemovalCluster.GetRightConstraintNode(currentNode);
                //  LeftNeighbors must end before the current node...
                let cLeftNeighbours: number = currentNode.LeftNeighbors.Count;
                for (let ii: number = 0; (ii < cLeftNeighbours); ii++) {
                    //  Keep track of the original Node; it may be the base of a Cluster, in which
                    //  case it will have the active neighbours list, not leftNeighborNode (which will
                    //  be the left border "fake Node").
                    let origLeftNeighborNode: OverlapRemovalNode = currentNode.LeftNeighbors[ii];
                    origLeftNeighborNode.RightNeighbors.Remove(currentNode);
                    let leftNeighborNode: OverlapRemovalNode = OverlapRemovalCluster.GetLeftConstraintNode(origLeftNeighborNode);
                    Debug.Assert((leftNeighborNode.OpenP == origLeftNeighborNode.OpenP), "leftNeighborNode.OpenP must == origLeftNeighborNode.OpenP");
                    //  This assert verifies we match the Solver.ViolationTolerance check in AddNeighbor.
                    //  We are closing the node here so use an alternative to OverlapP for additional
                    //  consistency verification.  Allow a little rounding error.
                    Debug.Assert((isHorizontal 
                                    || ((currentNode.CloseP 
                                    + (this.NodePaddingP - leftNeighborNode.OpenP)) 
                                    > (parameters.SolverParameters.GapTolerance - 1E-06))), "LeftNeighbors: unexpected close/open overlap");
                    let p: number = this.ClusterPadding;
                    // TODO: Warning!!!, inline IF is not supported ?
                    ((leftNeighborNode == this.LeftBorderNode) 
                                || (currentRightNode == this.RightBorderNode));
                    this.NodePadding;
                    let separation: number = (((leftNeighborNode.Size + currentRightNode.Size) 
                                / 2) 
                                + p);
                    ...
                    let cst: Constraint = solver.AddConstraint(leftNeighborNode.Variable, currentRightNode.Variable, separation);
                    Debug.Assert((cst != null), "LeftNeighbors: unexpected null cst");
                    #if (VERBOSE)
                ...
                //  ... and RightNeighbors must start after the current node.
                let cRightNeighbours: number = currentNode.RightNeighbors.Count;
                for (let ii: number = 0; (ii < cRightNeighbours); ii++) {
                    //  Keep original node, which may be a cluster; see comments in LeftNeighbors above.
                    let origRightNeighborNode: OverlapRemovalNode = currentNode.RightNeighbors[ii];
                    origRightNeighborNode.LeftNeighbors.Remove(currentNode);
                    let rightNeighborNode: OverlapRemovalNode = OverlapRemovalCluster.GetRightConstraintNode(origRightNeighborNode);
                    //  This assert verifies we match the Solver.ViolationTolerance check in AddNeighbor.
                    //  Allow a little rounding error.
                    Debug.Assert((isHorizontal 
                                    || ((currentNode.CloseP 
                                    + (this.NodePaddingP - rightNeighborNode.OpenP)) 
                                    > (parameters.SolverParameters.GapTolerance - 1E-06))), "RightNeighbors: unexpected close/open overlap");
                    let p: number = this.ClusterPadding;
                    // TODO: Warning!!!, inline IF is not supported ?
                    ((currentLeftNode == this.LeftBorderNode) 
                                || (rightNeighborNode == this.RightBorderNode));
                    this.NodePadding;
                    let separation: number = (((currentLeftNode.Size + rightNeighborNode.Size) 
                                / 2) 
                                + p);
                    if (this.TranslateChildren) {
                        separation = Math.Max(separation, (rightNeighborNode.Position - currentLeftNode.Position));
                    ...
                    let cst: Constraint = solver.AddConstraint(currentLeftNode.Variable, rightNeighborNode.Variable, separation);
                    Debug.Assert((cst != null), "RightNeighbors: unexpected null cst");
                    #if (VERBOSE)
        ...
        GetLeftNeighbours(parameters: OverlapRemovalParameters, scanLine: ScanLine, currentNode: OverlapRemovalNode, isHorizontal: boolean): List<OverlapRemovalNode> {
            let lstNeighbours = new List<OverlapRemovalNode>();
            let nextNode: OverlapRemovalNode = scanLine.NextLeft(currentNode);
            for (
            ; (nextNode != null); nextNode = scanLine.NextLeft(nextNode)) {
                //  AddNeighbor returns false if we are done adding them.
        ...
        //  end GetLeftNeighbours
        GetRightNeighbours(parameters: OverlapRemovalParameters, scanLine: ScanLine, currentNode: OverlapRemovalNode, isHorizontal: boolean): List<OverlapRemovalNode> {
            let lstNeighbours = new List<OverlapRemovalNode>();
            let nextNode: OverlapRemovalNode = scanLine.NextRight(currentNode);
            for (
            ; (nextNode != null); nextNode = scanLine.NextRight(nextNode)) {
                //  AddNeighbor returns false if we are done adding them.
        ...
        //  end GetRightNeighbours
        AddNeighbour(parameters: OverlapRemovalParameters, currentNode: OverlapRemovalNode, nextNode: OverlapRemovalNode, neighbors: List<OverlapRemovalNode>, isLeftNeighbor: boolean, isHorizontal: boolean): boolean {
            //  Sanity check to be sure that the borders are past all other nodes.
            Debug.Assert((currentNode != this.LeftBorderNode), "currentNode must != BorderNode");
            // TODO: Warning!!!, inline IF is not supported ?
            isLeftNeighbor;
            this.RightBorderNode;
            let overlap: number = Overlap(currentNode, nextNode, this.NodePadding);
            if ((overlap <= 0)) {
                //  This is the first node encountered on this neighbour-traversal that did not
                //  overlap within the required padding. Add it to the list and we're done with
                //  this traversal, unless this is a vertical pass and it is not an overlap on
                ...
                //  on why this is necessary).
                if ((!isHorizontal 
                            && (OverlapP(currentNode, nextNode, this.NodePaddingP) <= parameters.SolverParameters.GapTolerance))) {
                    #if (VERBOSE)
            ...
            if (isHorizontal) {
                if (parameters.AllowDeferToVertical) {
                    ...
                    //  this would allow two nodes to pop up/down if they're being squeezed, rather than
                    //  force apart the borders (which happens regardless of their weight).
                    let overlapP: number = OverlapP(currentNode, nextNode, this.NodePaddingP);
                    let isOverlapping: boolean = ((overlap 
                                / (currentNode.Size + nextNode.Size)) 
                                > (overlapP 
                                / (currentNode.SizeP + nextNode.SizeP)));
                    // TODO: Warning!!!, inline IF is not supported ?
                    parameters.ConsiderProportionalOverlap;
                    (overlap > overlapP);
                    if (isOverlapping) {
        ...
        //  Overrides Node.UpdateFromVariable.
        private /* internal */ /* override */ UpdateFromVariable() {
        ...
        UpdateFromVariableWorker() {
            ...
            if (!this.IsRootCluster) {
                ...
                //  that were empty; in that case we check that we don't have our Variables created.
                if ((this.IsEmpty 
                            || (this.LeftBorderNode.Variable == null))) {
                    return;
                }
                ...
                //  the border variables.  This leaves our single Node as having the size necessary to accommodate
                //  the internal padding when external nodes/clusters have their constraints to it formed.
                let clusterLeft: number = (this.LeftBorderNode.Position 
                            - (this.LeftBorderNode.Size / 2));
                let clusterRight: number = (this.RightBorderNode.Position 
                            + (this.RightBorderNode.Size / 2));
                this.Size = (clusterRight - clusterLeft);
                this.Position = (clusterLeft 
                            + (this.Size / 2));
            }
