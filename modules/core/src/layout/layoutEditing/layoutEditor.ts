...
// import { IViewerObject, getDrawingObject } from "./iViewerObject";
...
//     let drawingObject = getDrawingObject(viewerObject)
...
//     }
//     if ((drawingObject != null)) {
//         let geom = drawingObject.GeometryObject;
//         if ((geom != null)) {
//             geom.BeforeLayoutChangeEvent = (geom.BeforeLayoutChangeEvent + a);
//         }

//         b;
//         this.ReportBeforeChange(viewerObject);
//         let cluster = (<Cluster>(geom));
//         if ((cluster != null)) {
//             let iViewerNode = (<IViewerNode>(viewerObject));
//             iViewerNode.IsCollapsedChanged = (iViewerNode.IsCollapsedChanged + this.RelayoutOnIsCollapsedChanged);
//         }
...
//     this.geomGraphEditor.PrepareForClusterCollapseChange(new, [);
//     iCluster;
//     let cluster = (<Cluster>(iCluster.DrawingObject.GeometryObject));
...
// MakeExpandedNodesVisible(cluster: Cluster) {
