...
MSAGL.NET. This version is described in [New edge routing algorithm, and the tiling scheme in MSAGLJS](https://github.com/levnach/paper_msagljs/blob/main/main.pdf).
The paper also describes *tiling*: the feature allowing to browse a large graph similar to the online geographical maps. Only the WebGL viewer supports this feature.

Below is an example of routing in "Spline" mode.
